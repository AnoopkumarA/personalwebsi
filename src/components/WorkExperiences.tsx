...
export function WorkExperience() {
  return (
    <div id='experience' className="w-full flex flex-col items-center justify-center py-16 text-white">
      ...
      <StickyScroll
        content={workExperienceData.map((experience) => ({
          title: (<span className="font-castoro text-[#ff3000]">{experience.title}</span>),
          description: (
            <div className="p-4 font-montaga text-white">
